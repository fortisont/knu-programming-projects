...
CompiledSource::CompiledSource(): reg_amt(0), reg_list(0) {}

CompiledSource::CompiledSource(int new_reg_amt, vector<int> reg_vals): reg_amt(new_reg_amt), reg_list(reg_vals) {}
