...
public:
	UnknownInstructionTypeError(int err_code, string details): _err_code(err_code), _details(details){}
...
public:
	SyntaxError(int err_code, string details): _err_code(err_code), _details(details){}
	virtual ~SyntaxError(){}
	virtual int get_err_code() const { return _err_code; }
	virtual string get_details() const { return _details; }
